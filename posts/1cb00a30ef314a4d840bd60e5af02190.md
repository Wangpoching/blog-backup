...
![](https://static.coderbridge.com/img/Wangpoching/0f4d9e47997f4a70b2c60b401de9f05a.png)
* 登入以後創建新專案
![](https://static.coderbridge.com/img/Wangpoching/891d2d5940c34b4188f33e0b2bf066d2.png)
* 自己選個合適的名稱並建立專案
![](https://static.coderbridge.com/img/Wangpoching/a98967c036dd4ebe8af6b0559f59cf34.png)
* 這個時候在專案總列表應該就可以發現它了
#### 啟用 Gmail API
![](https://static.coderbridge.com/img/Wangpoching/bc45729cc6c84a10a6796ec946c33e01.png)
...
![](https://static.coderbridge.com/img/Wangpoching/3f970f66b1db4aec8c2edb6cff741dba.png)
* +啟用 API 和服務
![](https://static.coderbridge.com/img/Wangpoching/d45f975e494648c9af9a662ea6618eb2.png)
* 尋「Gmail API」，然後點選「Gmail API」
![](https://static.coderbridge.com/img/Wangpoching/a46a21f8a6eb4b9fb222e7012650bd96.png)
* 啟用
![](https://static.coderbridge.com/img/Wangpoching/36349a56bca842b18837b449ecdeb822.png)
#### 設定 OAuth 同意畫面
* 現在要先設定 OAuth 的同意畫面，就是讓使用者輸入 google 的帳密然後告知使用者即將授權給應用程式甚麼權限的那一頁~
回到「API 和服務」，然後點選「OAuth 同意畫面」
![](https://static.coderbridge.com/img/Wangpoching/ec9a86d99f134b30b270c68f355aa5b0.png)
* 選擇「外部」，然後點選「建立」
![](https://static.coderbridge.com/img/Wangpoching/c6f9eb4d11ef4b9cabc37604d09d19a3.png)
* 然後把資料填一填，不過這邊的應用程式名稱是會在 OAuth 授權頁面被使用者看到的喔! 仔細想想要怎麼命名吧~
![](https://static.coderbridge.com/img/Wangpoching/e26146d877c04f009a8bdb258cc61ea3.png)
* 這邊可以直接跳過
![](https://static.coderbridge.com/img/Wangpoching/b66c0b35e4314bbcbc7dfac1f76aa458.png)
* 最後如果是測試版的話可以輸入一些電子郵件，只有這些電子郵件可以授權給應用程式
![](https://static.coderbridge.com/img/Wangpoching/38c4c2bfb0ef4ac48a13f153a1cec07e.png)
...
![](https://static.coderbridge.com/img/Wangpoching/60615fc5d76c466cbd26cf278c4884fc.png)
* 在應用程式類型欄位選擇「網路應用程式」，然後輸入以下欄位：
名稱：自己取名
已授權的重新導向 URI：請輸入 http://localhost:3000/auth/google/callback
![](https://static.coderbridge.com/img/Wangpoching/da87bf289aee4a52982d66866d7b8057.png)
* 這個時候就可以拿到 CLIENT ID 以及密鑰了，把這些都存起來，然後不要外流，外流的話其他應用程式就可以打著你的名義跟其他使用者索取授權囉~
![](https://static.coderbridge.com/img/Wangpoching/856f31059fc04b1b8a1f513f9edd6abb.png)
...
## 成果展示
![](https://static.coderbridge.com/img/Wangpoching/40acb8b3480445e8b90ada737c5ae5b1.gif)
